...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute -left-20 top-3 mt-6 h-full">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
          ...
          className="border-netural-200 ml-[29px] flex h-4 w-4 items-center justify-center rounded-full border shadow-sm"
        >
          <motion.div
            transition={{
              duration: 0.2,
        ...
        <svg
          ...
          className=" lg:block tracing-svg ml-4"
          style={{
            height: svgHeight,
          }}
        >
