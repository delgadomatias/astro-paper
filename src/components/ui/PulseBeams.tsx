...
export const PulseBeams = () => {
  return (
    <>
      <div className="relative flex h-[500px] w-full  items-center justify-center overflow-hidden antialiased md:h-[40rem]">
        <button className="group relative z-40 inline-block h-[100px] w-[220px] cursor-pointer rounded-full bg-slate-800 p-px text-xs font-semibold leading-6 text-white  no-underline shadow-2xl shadow-zinc-900 md:h-[120px] md:w-[320px]">
  ...
  return (
    <>
      <svg
        ...
        className="flex h-full w-full flex-shrink-0 !fill-none text-white"
      >
        <path
